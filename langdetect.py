...
Original file is located at
    https://colab.research.google.com/drive/10wzCL5YcEmwVNAZ0Y_9oYckauhgkv4xp
"""
...
TOLKIEN_LANGUAGES = {"sn": "Sindarin", "qn": "Quenya", "nd": "Noldorin", "ad": "Adûnaic", "tn": "Telerin", "bs": "Black Speech"}
MIN_NGRAM = 1
MAX_NGRAM = 3
...
def create_languages_profiles():
    return {language: create_language_profile(language) for language in TOLKIEN_LANGUAGES}
